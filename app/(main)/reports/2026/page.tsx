                ...
                <div className="container-custom max-w-4xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-[var(--bg-secondary)] rounded-2xl border border-[var(--border-light)] p-6">
                            ...
                            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                                Covers payment processing fees, website hosting, administrative expenses, and salaries for the employees and individuals who manage and operate in the organisation.
                            </p>
                        </div>
                    </div>
