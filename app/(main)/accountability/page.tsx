                    ...
                    <div className="mt-10 p-5 bg-[var(--primary-green)]/5 border border-[var(--primary-green)]/20 rounded-2xl flex items-start gap-4 max-w-3xl mx-auto">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                                Unity Bridge Kenya retains a small 5% platform fee from each donation to cover payment processing, administrative operations, and salaries for the employees and individuals who manage and operate in the organisation. The remaining <strong>95%</strong> goes directly to the project.
                            </p>
                        </div>
                    </div>
                </div>
