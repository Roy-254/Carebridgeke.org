...
const MOCK_PROJECTS: FeaturedProject[] = [
    {
        ...
        description: "Providing tuition support and learning materials to help underprivileged students stay in school across multiple counties.",
        category: "school_fees",
        current_amount: 0,
        target_amount: 0,
        creator: { full_name: "Unity Bridge Kenya" },
        images: [{ storage_url: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=800", order_index: 0 }],
        donations: [],
    },
    {
        id: "2",
        ...
        target_amount: 0,
        creator: { full_name: "Unity Bridge Kenya" },
        images: [{ storage_url: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=800", order_index: 0 }],
        donations: [],
    },
    {
        id: "3",
        ...
        description: "Community-led initiatives providing essential resources and sustainable support for vulnerable families facing hardship.",
        category: "community",
        current_amount: 0,
        target_amount: 0,
        creator: { full_name: "Unity Bridge Kenya" },
    ...
    },
    {
        ...
        description: "A nationwide effort to clean up Kenya by collecting litter and unclogging drainage channels in public spaces.",
        category: "community",
        current_amount: 0,
        target_amount: 0,
        creator: { full_name: "Unity Bridge Kenya" },
        images: [{ storage_url: "https://images.unsplash.com/photo-1542601906990-b4d3fb773b09?w=800", order_index: 0 }],
        donations: [],
    },
];
