...
We believe that sustained access to education is the single greatest investment in Kenya's next generation. When you support this initiative, you are not just paying a fee — you are keeping a door open for a child who deserves every chance to succeed.`,
        ...
        view_count: 1250,
        is_verified: false,
        creator: { id: "u1", full_name: "Care Bridge Kenya", is_verified: false, county: "Nairobi" },
        images: [
...
Our Medical Relief Initiative at Care Bridge Kenya focuses on one of the most urgent and often invisible crises in Kenya's healthcare system: patients and families trapped by unpaid hospital bills, unable to be discharged, and facing deteriorating health with no means to cover the cost of their care.
...
Your contribution helps free patients from hospital debt and restores dignity to families at some of the most vulnerable moments of their lives. No one should have to stay sick because they cannot afford to get well.`,
        ...
        view_count: 3200,
        is_verified: false,
        creator: { id: "u2", full_name: "Care Bridge Kenya", is_verified: false, county: "Nairobi" },
        images: [
...
Your donation transforms the daily reality of entire villages — giving back time, restoring health, and unlocking opportunity for Kenya's most underserved communities.`,
        ...
        view_count: 5400,
        is_verified: false,
        creator: { id: "u3", full_name: "Care Bridge Kenya", is_verified: false, county: "Nairobi" },
        images: [
